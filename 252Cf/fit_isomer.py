...
def gauss(x, mean=0, sigma=1.0, amplitude_gauss=1.0, amplitude_exp=1.0, amplitude_exp2=1.0):
    """Gaussian component (prompt production and prompt decay)"""
    dx = mean-x
    return amplitude_gauss*np.exp(-(x-mean)**2/(2*sigma**2))

def exp(x, mean=0, sigma=1.0, amplitude_gauss=1.0, amplitude_exp=1.0, amplitude_exp2=1.0):
	""" Exponential decay """
	dx = mean-x
	return np.piecewise(x, [x < mean, x >= mean], [lambda x:0, lambda x:amplitude_exp*np.exp((mean-x)/tau)])

def smeared_exp(x, mean=0, sigma=1.0, amplitude_gauss=1.0, amplitude_exp=1.0, amplitude_exp2=1.0):
	""" Exponential decay """
	dx = mean-x
	return gaussian_filter1d(np.piecewise(x, [x < mean, x >= mean], [lambda x:0, lambda x:amplitude_exp*np.exp((mean-x)/tau)]),sigma)

def sum_smeared_exp_gauss(x, mean=0, sigma=1.0, amplitude_gauss=1.0, amplitude_exp=1.0, amplitude_exp2=1.0):
...
######################
P_isomer_1, cov_isomer_1 = curve_fit(func, x_isomer_1_gate_134Te, y_isomer_1_gate_134Te, bounds=([950,0,20,10,0],[1020,20,10000,10000,50]))
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_isomer_1[4])
...
P_isomer_1_all, cov_isomer_1_all = curve_fit(func, x_isomer_1_gate_all_134Te, y_isomer_1_gate_all_134Te, bounds=([990,10,120000,0,0],[1000,20,170000,30000,50]))
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_isomer_1_all[4])

P_isomer_1_bg, cov_isomer_1_bg = curve_fit(func, x_isomer_1_gate_bg_134Te, y_isomer_1_gate_bg_134Te, bounds=([990,0,140000,0,0],[1000,30,170000,18000,50]))
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_isomer_1_bg[4])

######################
#134Te isomer_2 gate fits
######################
P_isomer_2, cov_isomer_2 = curve_fit(func, x_isomer_2_gate_134Te, y_isomer_2_gate_134Te, bounds=([950,5,20,10,0],[1020,20,4000,4000,50]))
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_isomer_2[4])

P_isomer_2_all, cov_isomer_2_all = curve_fit(func, x_isomer_2_gate_all_134Te, y_isomer_2_gate_all_134Te, bounds=([990,0,0,0,0],[1000,30,170000,10000,50]))
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_isomer_2_all[4])

P_isomer_2_bg, cov_isomer_2_bg = curve_fit(func, x_isomer_2_gate_bg_134Te, y_isomer_2_gate_bg_134Te, bounds=([995,0,0,0,0],[1000,30,170000,10000,50]))
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_isomer_2_bg[4])
...
P_double, cov_double = curve_fit(func, x_doublegate_134Te, y_doublegate_134Te, bounds=([950,0,0,0,0],[1100,40,300,100,50])) #25nov
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_double[4])
...
P_double_all, cov_double_all = curve_fit(func, x_doublegate_all_134Te, y_doublegate_all_134Te, bounds=([950,0,20,10,0],[1100,40,300,200,50])) #25nov
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_double_all[4])
...
P_double_bg, cov_double_bg = curve_fit(func, x_doublegate_bg_134Te, y_doublegate_bg_134Te, bounds=([950,0,0,0,0],[1100,20,40,40,50])) #25.nov
# print("\n")
...
# print("amplitude_exp2: %.4f" % P_double_bg[4])
