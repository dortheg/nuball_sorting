...
IYR_double = (area_double_true_delayed)/(2*area_double_true_prompt + area_double_true_delayed)

sigma_area_double_true_prompt = np.sqrt(area_double_all_prompt + area_double_bg_prompt)
sigma_area_double_true_delayed = np.sqrt(area_double_all_delayed + area_double_bg_delayed)

p = area_double_true_prompt
d = area_double_true_delayed
sigma_p = sigma_area_double_true_prompt
sigma_d = sigma_area_double_true_delayed

sigma_IYR_double = np.sqrt( ((2*p/(2*p+d)**2)*sigma_d)**2 + ((-2*d/(2*p+d)**2)*sigma_p)**2 ) #Make this into a function
...
IYR_isomer_1_gate = (area_isomer_1_gate_true_delayed)/(2*area_isomer_1_gate_true_prompt + area_isomer_1_gate_true_delayed)
