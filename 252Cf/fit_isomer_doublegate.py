...
P_isomer_2_all, cov_isomer_2_all = curve_fit(sum_two_smeared_exp_gauss, x_isomer_2_gate_all_134Te, y_isomer_2_gate_all_134Te, sigma=sigma_fill_0(y_isomer_2_gate_all_134Te), bounds=([mean_lower,sigma_lower,amplitude_gauss_lower,amplitude_exp_Ge_lower,tau_Ge_lower,amplitude_exp_decay_lower,tau_decay_lower],[mean_upper,sigma_upper,amplitude_gauss_upper,amplitude_exp_Ge_upper,tau_Ge_upper,amplitude_exp_decay_upper,tau_decay_upper])) #30nov
# print("\n")
# print(" ***** 134Te: Isomer_2 all spectrum fit ***** ")
# print("          -- GAUSS + TWO SMEARED EXP FIT --   ")
# print("mean:                     %.2f         [%.d,%.d]" % (P_isomer_2_all[0], mean_lower, mean_upper))
# print("sigma:                    %.2f         [%.d,%.d]" % (P_isomer_2_all[1], sigma_lower, sigma_upper))
# print("amplitude_gauss:          %.2f         [%.d,%.d]" % (P_isomer_2_all[2], amplitude_gauss_lower, amplitude_gauss_upper))
# print("amplitude_exp_Ge:         %.2f         [%.d,%.d]" % (P_isomer_2_all[3], amplitude_exp_Ge_lower, amplitude_exp_Ge_upper))
# print("tau_Ge:                   %.2f         [%.d,%.d]" % (P_isomer_2_all[4], tau_Ge_lower, tau_Ge_upper))
# print("amplitude_exp_decay:      %.2f         [%.d,%.d]" % (P_isomer_2_all[5], amplitude_exp_decay_lower, amplitude_exp_decay_upper))
# print("tau_decay, in half_life:  %.2f         [%.d,%.d]" % (P_isomer_2_all[6]*np.log(2), tau_decay_lower*np.log(2), tau_decay_upper*np.log(2)))
# print("\n")
...
P_isomer_2_bg, cov_isomer_2_all = curve_fit(sum_two_smeared_exp_gauss, x_isomer_2_gate_bg_134Te, y_isomer_2_gate_bg_134Te, sigma=sigma_fill_0(y_isomer_2_gate_bg_134Te), bounds=([mean_lower,sigma_lower,amplitude_gauss_lower,amplitude_exp_Ge_lower,tau_Ge_lower,amplitude_exp_decay_lower,tau_decay_lower],[mean_upper,sigma_upper,amplitude_gauss_upper,amplitude_exp_Ge_upper,tau_Ge_upper,amplitude_exp_decay_upper,tau_decay_upper])) #30nov
# print("\n")
# print(" ***** 134Te: Isomer_2 bg spectrum fit ***** ")
# print("          -- GAUSS + TWO SMEARED EXP FIT --   ")
# print("mean:                     %.2f         [%.d,%.d]" % (P_isomer_2_bg[0], mean_lower, mean_upper))
# print("sigma:                    %.2f         [%.d,%.d]" % (P_isomer_2_bg[1], sigma_lower, sigma_upper))
# print("amplitude_gauss:          %.2f         [%.d,%.d]" % (P_isomer_2_bg[2], amplitude_gauss_lower, amplitude_gauss_upper))
# print("amplitude_exp_Ge:         %.2f         [%.d,%.d]" % (P_isomer_2_bg[3], amplitude_exp_Ge_lower, amplitude_exp_Ge_upper))
# print("tau_Ge:                   %.2f         [%.d,%.d]" % (P_isomer_2_bg[4], tau_Ge_lower, tau_Ge_upper))
# print("amplitude_exp_decay:      %.2f         [%.d,%.d]" % (P_isomer_2_bg[5], amplitude_exp_decay_lower, amplitude_exp_decay_upper))
# print("tau_decay, in half_life:  %.2f         [%.d,%.d]" % (P_isomer_2_bg[6]*np.log(2), tau_decay_lower*np.log(2), tau_decay_upper*np.log(2)))
# print("\n")
...
area_isomer_2_gate_true_delayed = np.trapz(smeared_exp_decay(x_arr, P_isomer_2[0], P_isomer_2[1], P_isomer_2[2], P_isomer_2[3], P_isomer_2[4], P_isomer_2[5], P_isomer_2[6]), x_arr)
...
area_isomer_2_gate_all = np.trapz(sum_two_smeared_exp_gauss(x_arr, P_isomer_2_all[0], P_isomer_2_all[1], P_isomer_2_all[2], P_isomer_2_all[3], P_isomer_2_all[4]), x_arr)
area_isomer_2_gate_all_prompt = np.trapz(gauss(x_arr, P_isomer_2_all[0], P_isomer_2_all[1], P_isomer_2_all[2], P_isomer_2_all[3], P_isomer_2_all[4], P_isomer_2_all[5], P_isomer_2_all[6])+smeared_exp_Ge(x_arr, P_isomer_2_all[0], P_isomer_2_all[1], P_isomer_2_all[2], P_isomer_2_all[3], P_isomer_2_all[4], P_isomer_2_all[5], P_isomer_2_all[6]), x_arr)
area_isomer_2_gate_all_delayed = np.trapz(smeared_exp_decay(x_arr, P_isomer_2_all[0], P_isomer_2_all[1], P_isomer_2_all[2], P_isomer_2_all[3], P_isomer_2_all[4]), x_arr)

area_isomer_2_gate_bg = np.trapz(sum_two_smeared_exp_gauss(x_arr, P_isomer_2_bg[0], P_isomer_2_bg[1], P_isomer_2_bg[2], P_isomer_2_bg[3], P_isomer_2_bg[4]), x_arr)
area_isomer_2_gate_bg_prompt = np.trapz(gauss(x_arr, P_isomer_2_bg[0], P_isomer_2_bg[1], P_isomer_2_bg[2], P_isomer_2_bg[3], P_isomer_2_bg[4], P_isomer_2_bg[5], P_isomer_2_bg[6])+smeared_exp_Ge(x_arr, P_isomer_2_bg[0], P_isomer_2_bg[1], P_isomer_2_bg[2], P_isomer_2_bg[3], P_isomer_2_bg[4], P_isomer_2_bg[5], P_isomer_2_bg[6]), x_arr)
area_isomer_2_gate_bg_delayed = np.trapz(smeared_exp_decay(x_arr, P_isomer_2_bg[0], P_isomer_2_bg[1], P_isomer_2_bg[2], P_isomer_2_bg[3], P_isomer_2_bg[4]), x_arr)

IYR_isomer_2 = IYR(prompt=area_isomer_2_gate_true_prompt, delayed=area_isomer_2_gate_true_delayed)
sigma_IYR_isomer_2 = sigma_IYR(prompt=area_isomer_2_gate_true_prompt, delayed=area_isomer_2_gate_true_delayed, all_prompt=area_isomer_2_gate_all_prompt, all_delayed=area_isomer_2_gate_all_delayed, bg_prompt=area_isomer_2_gate_bg_prompt, bg_delayed=area_isomer_2_gate_bg_delayed)
...
print("IYR_isomer_2:               %.3f +/- %.3f" % (IYR_isomer_2, sigma_IYR_isomer_2))
...
# plt.errorbar(x_isomer_2_gate_all_134Te, y_isomer_2_gate_all_134Te, yerr=sigma_fill_0(y_isomer_2_gate_all_134Te), label="isomer_2_all_134Te", color="black")
# plt.plot(x_arr, sum_two_smeared_exp_gauss(x_arr, P_isomer_2_all[0], P_isomer_2_all[1], P_isomer_2_all[2], P_isomer_2_all[3], P_isomer_2_all[4], P_isomer_2_all[5], P_isomer_2_all[6]), label="true fit, total", color="orange")
...
# plt.title("134Te: Isomer_2 (1279keV) all fit")
# plt.xlabel("Time [ns]", fontsize=14)
# plt.ylabel("Counts", fontsize=14)
# plt.legend(fontsize=10)
# plt.axis([800,2000,0,50000])
# plt.grid()
# plt.show()

# plt.errorbar(x_isomer_2_gate_bg_134Te, y_isomer_2_gate_bg_134Te, yerr=sigma_fill_0(y_isomer_2_gate_bg_134Te), label="isomer_2_bg_134Te", color="pink")
# plt.plot(x_arr, sum_two_smeared_exp_gauss(x_arr, P_isomer_2_bg[0], P_isomer_2_bg[1], P_isomer_2_bg[2], P_isomer_2_bg[3], P_isomer_2_bg[4], P_isomer_2_bg[5], P_isomer_2_bg[6]), label="true fit, total", color="orange")
