...
#Doublegate true
hist_doublegate_93Rb = file.Get('time_isomer_doublegate_93Rb')
x_bins = hist_doublegate_93Rb.GetNbinsX()

x_doublegate_93Rb = np.zeros(x_bins)
y_doublegate_93Rb = np.zeros(x_bins)
    
for i in range(x_bins):
    x_doublegate_93Rb[i] = hist_doublegate_93Rb.GetBinCenter(i+1)
    y_doublegate_93Rb[i] = hist_doublegate_93Rb.GetBinContent(i+1)

#Make up for 2ns bins
x_doublegate_93Rb = 2*x_doublegate_93Rb

x_doublegate_93Rb_long = x_doublegate_93Rb
y_doublegate_93Rb_long = y_doublegate_93Rb

x_doublegate_93Rb = x_doublegate_93Rb[bin_lower:bin_upper]
y_doublegate_93Rb = y_doublegate_93Rb[bin_lower:bin_upper]

print("\n")
print("FIT CHOICES")
print("* Fit range %d - %.d" % (x_doublegate_93Rb[0],x_doublegate_93Rb[-1]))
...
#For 93Rb
tau_93Rb = 111/np.log(2)
sigma_tau_93Rb = 11/np.log(2)
...
x_bg_slice = x_doublegate_93Rb_long[bg_time_lower//2:bg_time_upper//2]
y_bg_slice = y_doublegate_93Rb_long[bg_time_lower//2:bg_time_upper//2]
...
tau_decay_lower = tau_93Rb
tau_decay_upper = tau_93Rb+0.0001

#P_double, cov_double = curve_fit(sum_smeared_exp_gauss_const_bg, x_doublegate_93Rb, y_doublegate_93Rb, sigma=sigma_data_doublegate(y_doublegate_all_93Rb, y_doublegate_bg_ridge_93Rb, y_doublegate_bg_random_93Rb), bounds=([mean_lower,sigma_lower,const_bg_lower,amplitude_gauss_lower,amplitude_exp_decay_lower,tau_decay_lower],[mean_upper,sigma_upper,const_bg_upper,amplitude_gauss_upper,amplitude_exp_decay_upper,tau_decay_upper]))
#print("\n Using uncertainty-weighted fit")
P_double, cov_double = curve_fit(sum_smeared_exp_gauss_const_bg, x_doublegate_93Rb, y_doublegate_93Rb, bounds=([mean_lower,sigma_lower,const_bg_lower,amplitude_gauss_lower,amplitude_exp_decay_lower,tau_decay_lower],[mean_upper,sigma_upper,const_bg_upper,amplitude_gauss_upper,amplitude_exp_decay_upper,tau_decay_upper]))
P_double_unc = np.sqrt(np.diag(cov_double))

print("* Not using uncertainty-weighted fit")

print("\n")
print(" ***** 93Rb:  Doublegate true spectrum fit ***** ")
...
tau_decay_lower = 0#tau_93Rb
tau_decay_upper = 400#tau_93Rb+0.0001

P_double_all, cov_double_all = curve_fit(sum_smeared_exp_gauss_const_bg, x_doublegate_all_93Rb, y_doublegate_all_93Rb, bounds=([mean_lower,sigma_lower,const_bg_lower,amplitude_gauss_lower,amplitude_exp_decay_lower,tau_decay_lower],[mean_upper,sigma_upper,const_bg_upper,amplitude_gauss_upper,amplitude_exp_decay_upper,tau_decay_upper]))

# print("\n")
# print(" ***** 93Rb:  Doublegate all spectrum fit ***** ")
# print("          -- GAUSS + SMEARED EXP + CONST_BG FIT --   ")
...
P_double_bg, cov_double_bg = curve_fit(sum_smeared_exp_gauss_const_bg, x_doublegate_bg_93Rb, y_doublegate_bg_93Rb, bounds=([mean_lower,sigma_lower,const_bg_lower,amplitude_gauss_lower,amplitude_exp_decay_lower,tau_decay_lower],[mean_upper,sigma_upper,const_bg_upper,amplitude_gauss_upper,amplitude_exp_decay_upper,tau_decay_upper]))

# print("\n")
# print(" ***** 93Rb:  Doublegate bg spectrum fit ***** ")
# print("          -- GAUSS + SMEARED EXP + CONST_BG FIT --   ")
...
#True spectrum
#plt.plot(x_doublegate_93Rb, y_doublegate_93Rb, label="doublegate_93Rb", color="royalblue")
#plt.plot(x_doublegate_93Rb_long, y_doublegate_93Rb_long, label="doublegate_93Rb", color="royalblue")
plt.errorbar(x_doublegate_93Rb_long, y_doublegate_93Rb_long, yerr=sigma_data_doublegate(y_doublegate_all_93Rb_long, y_doublegate_bg_ridge_93Rb_long, y_doublegate_bg_random_93Rb_long), label="doublegate_93Rb", color="royalblue")
...
plt.vlines(x_doublegate_93Rb[0],0,6000, label="fit range", color="black")
plt.vlines(x_doublegate_93Rb[-1],0,6000, color="black")
plt.yscale("log")
plt.title("93Rb: Doublegate true spectrum fit")
...
# #All spectrum
# plt.plot(x_doublegate_all_93Rb_long, y_doublegate_all_93Rb_long, label="doublegate_all_93Rb", color="black")
...
# plt.vlines(x_doublegate_all_93Rb[0],0,6000, label="fit range", color="black")
# plt.vlines(x_doublegate_all_93Rb[-1],0,6000, color="black")

# plt.title("93Rb: Doublegate all spectrum fit")
# plt.xlabel("Time [ns]", fontsize=14)
# plt.ylabel("Counts", fontsize=14)
# plt.legend(fontsize=10)
# plt.grid()
...
# #BG spectrum
# plt.plot(x_doublegate_bg_93Rb_long, y_doublegate_bg_93Rb_long, label="doublegate_bg_93Rb", color="lightpink")
...
# plt.vlines(x_doublegate_bg_93Rb[0],0,6000, label="fit range", color="black")
# plt.vlines(x_doublegate_bg_93Rb[-1],0,6000, color="black")

# plt.title("93Rb: Doublegate bg spectrum fit")
# plt.xlabel("Time [ns]", fontsize=14)
# plt.ylabel("Counts", fontsize=14)
# plt.legend(fontsize=10)
# plt.grid()
